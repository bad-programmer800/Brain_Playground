...
namespace Brain
{
	...
	void SceneHierarchyPanel::OnImGuiRender()
	{
		...
		{
			if (ImGui::MenuItem("Ceate Empty Entity"))
			{
	...
	void SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		if (entity.HasComponent<CameraComponent>())
		{
				...
				treeNodeFlags, "Camera"))
			{
				...
				const char* projectionTypeStrings[] = { "Persepctive", "Orthographic" };
				...
				if (camera.GetProjectionType() == SceneCamera::ProjectionType::Orthographic)
				{
					...
					{
						camera.SetOrthorgraphicSize(orthoSize);
					}

					float orthoNear = camera.GetOrthographicNearClip();
					if (ImGui::DragFloat("Near", &orthoNear))
					{
						camera.SetOrthorgraphicNearClip(orthoNear);
					}

					float orthoFar = camera.GetOrthographicFarClip();
					if (ImGui::DragFloat("Far", &orthoFar))
					{
						camera.SetOrthorgraphicFarClip(orthoFar);
					}
