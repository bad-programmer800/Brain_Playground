...
namespace Brain
{
	...
	{
		// m_Yaw = m+Pitch = 0.0f; // lock camera rotation

		m_Position = CalculatePosition();

		glm::quat orientation = GetOrientation();
		m_ViewMatrix = glm::translate(glm::mat4(1.0f),
			m_Position) * glm::toMat4(orientation);
	...
	void EditorCamera::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(BR_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
	}
