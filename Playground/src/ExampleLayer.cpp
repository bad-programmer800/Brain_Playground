	...
	: Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
	...
	m_Texture = Brain::Texture2D::Create("assets/textures/Checkerboard.png");
	m_ChernoLogoTexture = Brain::Texture2D::Create("assets/textures/ChernoLogo.png");
...
void ExampleLayer::OnUpdate(Brain::Timestep ts) 
{
	// Update
...
void ExampleLayer::OnEvent(Brain::Event& e) 
{
