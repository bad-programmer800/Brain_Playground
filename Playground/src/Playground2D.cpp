...
Playground2D::Playground2D()
	: Layer("Playground2D"), m_CameraController(1280.0f / 720.0f), m_SquareColor({ 0.2f, 0.3f, 0.8f, 1.0f })
{
}
...
void Playground2D::OnUpdate(Brain::Timestep ts)
{
	BR_PROFILE_FUNCTION();
...
void Playground2D::OnEvent(Brain::Event& e)
{
